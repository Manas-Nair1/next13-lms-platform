...
-- CreateIndex
CREATE UNIQUE INDEX "QuizData_chapterId_key" ON "QuizData"("chapterId");
...
-- AddForeignKey
ALTER TABLE "QuizData" ADD CONSTRAINT "QuizData_chapterId_fkey" FOREIGN KEY ("chapterId") REFERENCES "Chapter"("id") ON DELETE CASCADE ON UPDATE CASCADE;
